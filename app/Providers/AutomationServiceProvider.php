    ...
    private function registerTriggers(NodeTypeRegistry $registry): void
    {
        $registry->register(new NodeTypeDefinition(
            ...
            outputSchema: [
                ...
                'job.title' => ['type' => 'string', 'description' => 'Título del proceso'],
                'job.workflow_id' => ['type' => 'string', 'description' => 'ID del flujo de trabajo'],
                'job.workflow_stage_id' => ['type' => 'string', 'description' => 'ID de la etapa actual'],
                'job.due_date' => ['type' => 'string', 'description' => 'Fecha de vencimiento'],
                'job.metadata' => ['type' => 'object', 'description' => 'Metadatos personalizados'],
                ...
                'invoice' => ['type' => 'object', 'description' => 'Factura asociada (si existe)'],
                ...
                'from_stage' => ['type' => 'object', 'description' => 'Etapa anterior (si existe)'],
                'to_stage' => ['type' => 'object', 'description' => 'Etapa destino'],
            ],
        ));
