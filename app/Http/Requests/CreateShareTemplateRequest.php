...
final class CreateShareTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'template_pair' => [
                Rule::unique('share_templates', 'entity_type')->where(fn ($query) => $query->where('channel', $this->string('channel')->value())),
            ],
        ];
    }
