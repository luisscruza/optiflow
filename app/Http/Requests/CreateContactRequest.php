...
final class CreateContactRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone_primary' => ['nullable', 'string', 'regex:/^\(\d{3}\) \d{3} \d{4}$/'],
            'phone_secondary' => ['nullable', 'string', 'regex:/^\(\d{3}\) \d{3} \d{4}$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'phone_primary.regex' => 'El teléfono principal debe tener el formato (XXX) XXX XXXX.',
            'phone_secondary.regex' => 'El teléfono secundario debe tener el formato (XXX) XXX XXXX.',
