...
final readonly class UpdateAutomationAction
{
     ...
     */
    public function handle(Automation $automation, User $user, array $data): Automation
    {
        return DB::transaction(function () use ($automation, $user, $data): Automation {
            $automation->update([
                'name' => $data['name'],
