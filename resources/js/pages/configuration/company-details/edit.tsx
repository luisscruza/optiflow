                        ...
                        <>
                            ...
                            <Card className="mt-6">
                                <CardHeader>
                                    ...
                                    <CardDescription>Términos y condiciones por defecto a mostrar en facturas.</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        {errors.terms_conditions && (
                                            <p className="text-sm text-red-600 dark:text-red-400">{errors.terms_conditions}</p>
                                        )}
                                    </div>
                                </CardContent>
                            </Card>
