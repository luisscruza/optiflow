import { ArrowLeftRight, ArrowLeft, Package, Building2 } from 'lucide-react';
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Transfer stock from {workspace.name} to another workspace
            </p>
          </div>
        </div>
        ...
        <div className="max-w-2xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select a product and destination workspace for the transfer
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {errors.to_workspace_id && (
                    <p className="text-sm text-destructive">{errors.to_workspace_id}</p>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  {selectedProduct && (
                    <p className="text-sm text-muted-foreground">
                      Maximum available: {getAvailableStock()}
                    </p>
                  )}
                  {errors.quantity && (
