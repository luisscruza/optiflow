import { AlertTriangle, ArrowLeftRight, Calendar, DollarSign, Package, Plus, RotateCcw, TrendingUp } from 'lucide-react';
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-muted-foreground">Debajo del umbral mínimo</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-muted-foreground">Artículos sin cantidad</p>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    <p className="text-xs text-muted-foreground">Valor actual del inventario</p>
                                </CardContent>
                            </Card>
                        </div>
                    )}
