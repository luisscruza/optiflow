                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground">Set up and manage Inventario inicial levels for products in {workspace.name}</p>
                        </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Overview of stock-tracked products and their current status</CardDescription>
                        </CardHeader>
                        <CardContent>
