import { Calculator, Plus, Search, MoreHorizontal, Eye, Edit, Trash2, Star } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Administra las tasas de impuestos para tus productos y documentos
              </p>
            </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Lista de todos los impuestos configurados
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="flex space-x-2">
                    {taxes.links.prev && (
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.get(taxes.links.prev!)}
                      >
                        Anterior
                      </Button>
                    )}
                    {taxes.links.next && (
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.get(taxes.links.next!)}
                      >
                        Siguiente
                      </Button>
                    )}
