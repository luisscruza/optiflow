        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Actualiza los detalles del impuesto
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Ingresa la tasa de impuesto como porcentaje (0-100)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="is_default">
                  Establecer como impuesto predeterminado
                </Label>
              </div>
              {data.is_default && (
                <p className="text-sm text-amber-600 bg-amber-50 dark:bg-amber-900/20 p-3 rounded-md">
