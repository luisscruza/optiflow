        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <div className="">
                    ...
                    <div className="mb-6 rounded-lg border border-blue-200 bg-background p-4 dark:border-blue-800 dark:bg-blue-900/20">
                                        ...
                                        <div
                                            ...
                                            className={`cursor-pointer rounded-lg border p-4 transition-colors ${
                                                data.contact_type === type.value
                                                    ? 'border-blue-500 bg-background dark:bg-blue-900/20'
